    ...
    <>
      ...
      <motion.section {...sectionAnim} className="mt-12">
        ...
        <p className="text-muted leading-relaxed mb-4">
          The investigation engine chains all four agents sequentially: Pattern Finder →
          Timeline Builder → Evidence Ranker → Report Compiler. The final report is
          converted into an audio script that ElevenLabs narrates in an NPR-style voice
          (&quot;Drew&quot;). K2 Think assists with parsing fragmented raw data and
          structuring it into ordered JSON before agent consumption.
        </p>
        <MediaPlaceholder
          type="diagram"
